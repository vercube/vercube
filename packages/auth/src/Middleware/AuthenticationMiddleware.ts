import { type BeforeMiddleware, type MiddlewareOptions, type HttpEvent, UnauthorizedError } from '@vercube/core';
 ...
 */
export class AuthenticationMiddleware implements BeforeMiddleware {
