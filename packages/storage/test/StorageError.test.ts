...
describe('StorageError', () => {
  it('should create a StorageError with all properties', () => {
    ...
    const storageError = new StorageError('Failed to perform operation', 'testOperation', originalError, metadata);
  ...
  it('should create a StorageError without cause', () => {
    const storageError = new StorageError('Failed to perform operation', 'testOperation');
  ...
  it('should create a StorageError without metadata', () => {
    ...
    const storageError = new StorageError('Failed to perform operation', 'testOperation', originalError);
