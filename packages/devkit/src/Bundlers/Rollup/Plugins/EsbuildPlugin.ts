...
/**
 * Rollup plugin to transform files using esbuild.
 * This plugin is copied from the Unbind project.
 * @see https://github.com/unjs/unbuild/blob/main/src/builders/rollup/plugins/esbuild.ts
 *
 * @param {EsbuildOptions} options - The options for the esbuild plugin.
 * @returns {Plugin} The Rollup plugin.
 */
export function RollupEsbuildPlugin(options: EsbuildOptions): Plugin {
 ...
 * @param {TransformResult} result - The esbuild transform result.
 * @param {PluginContext} plugin - The Rollup plugin context.
 */
