const startColor: { r: number; g: number; b: number } = { r: 149, g: 100, b: 245 }; // Purple
const endColor: { r: number; g: number; b: number } = { r: 111, g: 114, b: 245 };   // Blue
...
function interpolateColor(startColor: { r: number; g: number; b: number }, endColor: { r: number; g: number; b: number }, factor: number) {
...
function applyGradient(icon: string[], startColor: { r: number; g: number; b: number }, endColor: { r: number; g: number; b: number }) {
