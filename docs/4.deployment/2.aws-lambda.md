...
::tip{icon="i-lucide-puzzle"}
This guide focuses on **deploying** to AWS. For what `toServerlessHandler` does and how events map to `Request` / `Response`, read the [Serverless module overview](/docs/modules/serverless/overview).
::
