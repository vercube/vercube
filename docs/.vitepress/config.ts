    ...
    sidebar: {
      ...
      '/modules/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: 'Overview', link: '/modules/ws' },
            { text: 'Websocket Plugin', link: '/modules/ws/websocket-plugin' },
            { text: 'Namespace Decorator', link: '/modules/ws/namespace-decorator' },
            { text: 'OnConnectionAttempt Decorator', link: '/modules/ws/on-connection-attempt-decorator' },
            { text: 'Message Decorator', link: '/modules/ws/message-decorator' },
            { text: 'Emit Decorator', link: '/modules/ws/emit-decorator' },
            { text: 'Broadcast Decorator', link: '/modules/ws/broadcast-decorator' },
            { text: 'BroadcastOthers Decorator', link: '/modules/ws/broadcast-others-decorator' },
          ],
        },
        {
          text: 'H3',
