...
Standard Nitro route files work exactly as documented in the [Nitro docs](https://nitro.build/docs/routing). They are handled by Nitro's own routing layer and are completely unaware of Vercube:

:::code-group
```ts [src/routes/health.get.ts]
