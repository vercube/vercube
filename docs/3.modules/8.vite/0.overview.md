...
The [`@vercube/ws`](/modules/web-sockets/overview) plugin works in both dev and production. Register it from your `setupFile` and define WebSocket controllers (`@Controller` + `@Namespace`) as usual. They are auto-discovered alongside HTTP controllers.
