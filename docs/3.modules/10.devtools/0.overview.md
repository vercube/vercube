...
An open queue can also be read: the messages waiting, delayed or sitting in a failed set, on transports that can be looked at without consuming them. Memory and BullMQ can, RabbitMQ and Kafka say so instead of perturbing your queue.
